package com.example.java_giorgi_lasurashvili;
...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {
        Label label = new Label("Add a new flight");
    ...
    public void insert(Flight flight) {
        String insertsql = "INSERT INTO flights(location, destination, date, sits, price) VALUES(" +
                "'" + flight.getLocation() + "', " +
        ...
        try {
            JDBCClass.getStatement().executeUpdate(insertsql);
    ...
    public ObservableList<Flight> getProduct() {
        ...
        try {
            ResultSet resultSet = JDBCClass.getStatement().executeQuery(selectsql);
